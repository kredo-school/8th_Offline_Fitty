        ...
        <div class="col-md-9 ms-sm-auto col-lg-10 d-flex justify-content-center align-items-center" style="min-height: calc(100vh - 190px);">
            ...
            @if(Auth::user()->role === 'A')
                <form action="{{route('admin.users.allocateNutritionist',$user->id)}}" method="post" class="w-100">
                    ...
                    <select name="nutritionist_id" id="allocate" class="my-3 form-select-sm w-100">
            ...
            <div class="profile-card profile-card-view w-100" style="max-width: 600px;">  <div class="profile-header profile-header-view">
                    @if($user->avatar)
                ...
                <div class="details details-view">
                    <div class="row">
                        <div class="detail-item detail-item-view col-sm-6"> <span class="detail-label detail-label-view">Gender</span>
                            <span class="detail-value detail-value-view">{{ $user->profile->gender }}</span>
                        </div>
                        <div class="detail-item detail-item-view col-sm-6"> <span class="detail-label detail-label-view">Birthday</span>
                            <span class="detail-value detail-value-view">{{ \Carbon\Carbon::parse($user->profile->birthday)->format('m-d-Y') }}</span>
                        </div>
                    </div>
                    <div class="row">
                        <div class="detail-item detail-item-view col-sm-6"> <span class="detail-label detail-label-view">Height</span>
                            <span class="detail-value detail-value-view">{{ $user->profile->height }}</span>
                        </div>
                        <div class="detail-item detail-item-view col-sm-6"> <span class="detail-label detail-label-view">Activity Level</span>
