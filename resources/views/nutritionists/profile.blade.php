    ...
    <div class="profile-card profile-card-view">
        ...
        <div class="details details-view">
            ...
            <div class="detail-item detail-item-view">
                ...
                <span class="detail-value detail-value-view">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur auctor nisi a erat tristique, nec gravida justo bibendum.</span>
            </div>
        </div>
